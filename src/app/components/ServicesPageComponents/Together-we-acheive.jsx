export default function TogetherWeAchieve() {
  const impacts = [
    {
      id: 1,
      number: "5,000+",
      title: "Families Supported",
      description: "Families Supported with food and essentials each year.",
    },
    {
      id: 2,
      number: "200+",
    ...
    },
    {
      ...
      description:
        "Healthcare Camps Organized to ensure access to medical treatment.",
    },
  ];
